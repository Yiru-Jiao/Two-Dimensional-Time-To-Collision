...
A document explaining my computation is provided [here](A_fast_calculation_of_2DTTC.pdf), where the core idea is 
$$TTC=\frac{DTC}{\Vert\boldsymbol{v}_{ij}\Vert},$$ 
where $DTC$ means a distance to collision, as shown in the figure below.
...
$$DRAC=\frac{\|\boldsymbol{v}_{ij}\|^2}{2DTC};$$ 
$$MTTC=\frac{-\|\boldsymbol{v}_{ij}\|\pm\sqrt{\|\boldsymbol{v}_{ij}\|^2+2(\boldsymbol{a}_i-\boldsymbol{a}_j)DTC}}{\boldsymbol{a}_i-\boldsymbol{a}_j}$$ 
